...
import com.microsoft.azure.management.datalake.store.CreateFirewallRuleWithAccountParameters;
...
import com.microsoft.azure.management.datalake.store.CreateTrustedIdProviderWithAccountParameters;
...
/**
 * The CreateDataLakeStoreAccountParametersInner model.
 */
@JsonFlatten
public class CreateDataLakeStoreAccountParametersInner {
    /**
     ...
     * @return the CreateDataLakeStoreAccountParametersInner object itself.
     */
    public CreateDataLakeStoreAccountParametersInner withLocation(String location) {
     ...
     * @return the CreateDataLakeStoreAccountParametersInner object itself.
     */
    public CreateDataLakeStoreAccountParametersInner withTags(Map<String, String> tags) {
        this.tags = tags;
        return this;
    }
     ...
     * @return the CreateDataLakeStoreAccountParametersInner object itself.
     */
    public CreateDataLakeStoreAccountParametersInner withIdentity(EncryptionIdentity identity) {
     ...
     * @return the CreateDataLakeStoreAccountParametersInner object itself.
     */
    public CreateDataLakeStoreAccountParametersInner withDefaultGroup(String defaultGroup) {
     ...
     * @return the CreateDataLakeStoreAccountParametersInner object itself.
     */
    public CreateDataLakeStoreAccountParametersInner withEncryptionConfig(EncryptionConfig encryptionConfig) {
     ...
     * @return the CreateDataLakeStoreAccountParametersInner object itself.
     */
    public CreateDataLakeStoreAccountParametersInner withEncryptionState(EncryptionState encryptionState) {
     ...
     * @return the CreateDataLakeStoreAccountParametersInner object itself.
     */
    public CreateDataLakeStoreAccountParametersInner withFirewallRules(List<CreateFirewallRuleWithAccountParameters> firewallRules) {
     ...
     * @return the CreateDataLakeStoreAccountParametersInner object itself.
     */
    public CreateDataLakeStoreAccountParametersInner withFirewallState(FirewallState firewallState) {
     ...
     * @return the CreateDataLakeStoreAccountParametersInner object itself.
     */
    public CreateDataLakeStoreAccountParametersInner withFirewallAllowAzureIps(FirewallAllowAzureIpsState firewallAllowAzureIps) {
     ...
     * @return the CreateDataLakeStoreAccountParametersInner object itself.
     */
    public CreateDataLakeStoreAccountParametersInner withTrustedIdProviders(List<CreateTrustedIdProviderWithAccountParameters> trustedIdProviders) {
     ...
     * @return the CreateDataLakeStoreAccountParametersInner object itself.
     */
    public CreateDataLakeStoreAccountParametersInner withTrustedIdProviderState(TrustedIdProviderState trustedIdProviderState) {
     ...
     * @return the CreateDataLakeStoreAccountParametersInner object itself.
     */
    public CreateDataLakeStoreAccountParametersInner withNewTier(TierType newTier) {
