...
import com.microsoft.azure.management.datalake.store.UpdateEncryptionConfig;
import java.util.List;
import com.microsoft.azure.management.datalake.store.UpdateFirewallRuleWithAccountParameters;
...
import com.microsoft.azure.management.datalake.store.UpdateTrustedIdProviderWithAccountParameters;
 ...
 */
@JsonFlatten
public class UpdateDataLakeStoreAccountParametersInner {
    /**
     * Resource tags.
     */
     ...
     * @return the UpdateDataLakeStoreAccountParametersInner object itself.
     */
    public UpdateDataLakeStoreAccountParametersInner withTags(Map<String, String> tags) {
        this.tags = tags;
        return this;
    }
     ...
     * @return the UpdateDataLakeStoreAccountParametersInner object itself.
     */
    public UpdateDataLakeStoreAccountParametersInner withDefaultGroup(String defaultGroup) {
     ...
     * @return the UpdateDataLakeStoreAccountParametersInner object itself.
     */
    public UpdateDataLakeStoreAccountParametersInner withEncryptionConfig(UpdateEncryptionConfig encryptionConfig) {
     ...
     * @return the UpdateDataLakeStoreAccountParametersInner object itself.
     */
    public UpdateDataLakeStoreAccountParametersInner withFirewallRules(List<UpdateFirewallRuleWithAccountParameters> firewallRules) {
     ...
     * @return the UpdateDataLakeStoreAccountParametersInner object itself.
     */
    public UpdateDataLakeStoreAccountParametersInner withFirewallState(FirewallState firewallState) {
     ...
     * @return the UpdateDataLakeStoreAccountParametersInner object itself.
     */
    public UpdateDataLakeStoreAccountParametersInner withFirewallAllowAzureIps(FirewallAllowAzureIpsState firewallAllowAzureIps) {
     ...
     * @return the UpdateDataLakeStoreAccountParametersInner object itself.
     */
    public UpdateDataLakeStoreAccountParametersInner withTrustedIdProviders(List<UpdateTrustedIdProviderWithAccountParameters> trustedIdProviders) {
     ...
     * @return the UpdateDataLakeStoreAccountParametersInner object itself.
     */
    public UpdateDataLakeStoreAccountParametersInner withTrustedIdProviderState(TrustedIdProviderState trustedIdProviderState) {
     ...
     * @return the UpdateDataLakeStoreAccountParametersInner object itself.
     */
    public UpdateDataLakeStoreAccountParametersInner withNewTier(TierType newTier) {
