...
public class FirewallRulesInner {
     ...
     */
    public FirewallRuleInner createOrUpdate(String resourceGroupName, String accountName, String firewallRuleName, String startIpAddress, String endIpAddress) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<FirewallRuleInner> createOrUpdateAsync(String resourceGroupName, String accountName, String firewallRuleName, String startIpAddress, String endIpAddress, final ServiceCallback<FirewallRuleInner> serviceCallback) {
     ...
     */
    public Observable<FirewallRuleInner> createOrUpdateAsync(String resourceGroupName, String accountName, String firewallRuleName, String startIpAddress, String endIpAddress) {
        return createOrUpdateWithServiceResponseAsync(resourceGroupName, accountName, firewallRuleName, startIpAddress, endIpAddress).map(new Func1<ServiceResponse<FirewallRuleInner>, FirewallRuleInner>() {
            @Override
     ...
     * @return the observable to the FirewallRuleInner object
     */
    public Observable<ServiceResponse<FirewallRuleInner>> createOrUpdateWithServiceResponseAsync(String resourceGroupName, String accountName, String firewallRuleName, String startIpAddress, String endIpAddress) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
     ...
     * @return the FirewallRuleInner object if successful.
     */
    public FirewallRuleInner update(String resourceGroupName, String accountName, String firewallRuleName, String startIpAddress, String endIpAddress) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<FirewallRuleInner> updateAsync(String resourceGroupName, String accountName, String firewallRuleName, String startIpAddress, String endIpAddress, final ServiceCallback<FirewallRuleInner> serviceCallback) {
     ...
     * @return the observable to the FirewallRuleInner object
     */
    public Observable<FirewallRuleInner> updateAsync(String resourceGroupName, String accountName, String firewallRuleName, String startIpAddress, String endIpAddress) {
        return updateWithServiceResponseAsync(resourceGroupName, accountName, firewallRuleName, startIpAddress, endIpAddress).map(new Func1<ServiceResponse<FirewallRuleInner>, FirewallRuleInner>() {
            @Override
            public FirewallRuleInner call(ServiceResponse<FirewallRuleInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the FirewallRuleInner object
     */
    public Observable<ServiceResponse<FirewallRuleInner>> updateWithServiceResponseAsync(String resourceGroupName, String accountName, String firewallRuleName, String startIpAddress, String endIpAddress) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
